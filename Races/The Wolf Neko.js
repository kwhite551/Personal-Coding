...
/*	-INFORMATION-
	Subject:	Race
	Effect:		This script adds a player race, called the "Wolf Neko" and it's subraces and variants for each subrace
...
var iFileName = "Wolf Neko [Created by Perry, transcribed by Seneschal].js";
RequiredSheetVersion(13);

SourceList["P:WN"] = { //Object name; This is the way the source is called upon, so the way you would enter it as the "Source" in any other of the JavaScript Syntax. Note that this is case sensitive! //Also note that this has to be an unique value. Look at the default sources in the "Complete SourceList.js" file
	name : "Perry's Wolf Neko", //Required; The name of the source as written in full. This will be used in the tooltips/mouseover text.
	abbreviation : "P:WN", //Required; The abbreviation of the source. This can only be letters and a colon! This will be used to refer to the source in the form fields //Note that this doesn't have to be the same as the way the source is called upon, but it can be for convenience
...
//Create Wolf Neko Object
RaceList["wolf neko"] = {
	regExpSearch : /^(?=.*wolf)(?=.*neko).*$/i,
	name : "Wolf Neko",
	sortname : "Neko, Wolf",
	source : [["P:WN", 0]],
	plural : "Wolf Neko",
	...
	weaponsAdd : ["Wolf Neko's Bite", "Wolf Neko's Claws"],
	...
	improvements : "Wolf Neko: +2 Strength, +1 Charisma",
	scores : [2, 0, 0, 0, 0, 1],
	trait : "Wolf Neko (+2 Strength, +1 Charisma)\n Canine Claws and Teeth: Access to bite and claw attacks and climbing speed.\n" 
	...
	+ "Pack Tactics: Advantage on enemies who are within 5 feet of a conscious ally. Disadvantage on Wisdom (Survival) when tracking 2 or more Wolf Neko and Wisdom (Perception) when trying to see 3 or more."
}

//Wolf Neko Weapons
	WeaponsList["wolf neko bite"] = {
	regExpSearch : /^(?=.*wolf neko)(?=.*\bbites?\b).*$/i,
	name : "Wolf Neko's Bite",
	source : ["P:WN", 0],
	ability : 1,
	type : "Natural",
	damage : [1, 4, "piercing"],
...
WeaponsList["wolf neko claws"] = {
	regExpSearch : /^(?=.*wolf neko)(?=.*\bclaws?\b).*$/i,
	name : "Wolf Neko's Claws",
	source : ["P:WN", 0],
	ability : 1,
	type : "Natural",
	damage : [1, 4, "slashing"],
